...
namespace Spart.Parsers
{
	...
	public class Ops
	{
        ...
        public static SequenceParser Seq(params Parser[] args)
        {
        ...
        /// <returns></returns>
        public static AlternativeParser Or(params Parser[] args)
        {
        ...
        /// <returns></returns>
        public static RepetitionParser Star(Parser parser)
        {
            if (parser == null)
        ...
        /// <param name="parser"></param>
        /// <returns></returns>
        public static RepetitionParser Plus(Parser parser)
        {
            if (parser == null)
                throw new ArgumentNullException("parser");
